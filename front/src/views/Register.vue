  ...
  setup () {
    ...
    const onSubmit = async () => {
        ...
        if (username.value === "" || email.value === "" || password.value === "" || confirmPassword.value === "") {
            ...
            errorMessage.value = "Missing a required field"
        }
        else {
